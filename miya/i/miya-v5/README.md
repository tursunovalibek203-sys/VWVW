...
MEDIUM (3-8 fayl, 1-2 jadval) → + Security
LARGE  (8+ fayl, ko'p jadval) → To'liq zanjir
```
...
```bash
# 1. Templates ko'chiring
cp -r templates/* /your-project/

# 2. Persistence papkasi
mkdir -p /your-project/.miya/results

# 3. Claude Code
claude

# 4. MiyaAI yuklang → birinchi prompt:
